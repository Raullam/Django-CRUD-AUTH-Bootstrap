...
def create_task(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'create_task.html', {'form': form, 'error': 'Por favor ingresa datos válidos.'})
@login_required
...
def pending_tasks(request):
    ...
    tasks = Task.objects.filter(user=request.user, date_completed__isnull=True).order_by('-created_at')
    return render(request, 'tasks_pending.html', {'tasks': tasks})
